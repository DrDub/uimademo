...
public class Parse_Type extends Annotation_Type {
   ...
   */ 
  public String getTtype(int addr) {
        if (featOkTst && casFeat_ttype == null)
      jcas.throwFeatMissing("ttype", "opennlp.uima.Parse");
    return ll_cas.ll_getStringValue(addr, casFeatCode_ttype);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setTtype(int addr, String v) {
        if (featOkTst && casFeat_ttype == null)
      jcas.throwFeatMissing("ttype", "opennlp.uima.Parse");
    ll_cas.ll_setStringValue(addr, casFeatCode_ttype, v);}
  ...
  public Parse_Type(JCas jcas, Type casType) {
    ...
    casFeat_ttype = jcas.getRequiredFeatureDE(casType, "ttype", "uima.cas.String", featOkTst);
    casFeatCode_ttype  = (null == casFeat_ttype) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_ttype).getCode();
