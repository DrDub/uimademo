 ...
 * XML source: /raid/home/pablo/work/keatext/workspace/uimademo/src/main/resources/org/apache/opennlp/TypeSystem.xml
 * @generated */
public class Parse extends Annotation {
  ...
  */  
  ...
  /** getter for ttype - gets Type of the parse node
   * @generated
   * @return value of the feature 
   */
  public String getTtype() {
    if (Parse_Type.featOkTst && ((Parse_Type)jcasType).casFeat_ttype == null)
      jcasType.jcas.throwFeatMissing("type", "opennlp.uima.Parse");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Parse_Type)jcasType).casFeatCode_ttype);}
    
  /** setter for ttype - sets Type of the parse node 
   * @generated
  ...
  public void setTtype(String v) {
    if (Parse_Type.featOkTst && ((Parse_Type)jcasType).casFeat_ttype == null)
      jcasType.jcas.throwFeatMissing("type", "opennlp.uima.Parse");
    jcasType.ll_cas.ll_setStringValue(addr, ((Parse_Type)jcasType).casFeatCode_ttype, v);}    
